-- Replace get_global_leaderboard to use base points (before power-up multipliers).
-- Categories based on result direction (win/draw/loss), NOT on whether base_pts > 0,
-- because GolPredictor awards partial points even for wrong result direction.
